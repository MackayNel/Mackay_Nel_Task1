...
namespace Mackay_Nel_Task1
{
    ...
    public class MeleeUnit : Unit
    {
        ...
        public string Unit_types//Task 2 Q)2.3 added unit types
        {
            get { return unit_types; }
            set { unit_types = value; }
        }

        public MeleeUnit(int x, int y, int h, int s, int a, int f, string sy, string ut)//Task 2 Q)2.3 added unit types
        {
            XPos = x;
            YPos = y;
            Health = h;
